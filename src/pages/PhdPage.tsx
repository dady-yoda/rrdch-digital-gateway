  ...
  return (
    <PageLayout>
      <PageHero
        ...
        breadcrumbs={[{ label: "Courses", href: "#" }, { label: "Ph.D" }]}
      />
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground ml-7">3-5 Years</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground ml-7">As per RGUHS guidelines</p>
                </div>
              </div>
            ...
            <div className="mt-10 pt-8 border-t border-border">
              <h3 className="font-heading font-semibold text-xl text-foreground flex items-center gap-2 mb-6">
                <Layers className="w-6 h-6 text-primary" /> Ph.D - Course Description
              </h3>
