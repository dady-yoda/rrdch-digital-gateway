  ...
  return (
    <PageLayout>
      <PageHero
        ...
        subtitle="Undergraduate Dental Degree"
        breadcrumbs={[{ label: "Courses", href: "#" }, { label: "BDS" }]}
      />
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground ml-7">4 Years + 1 Year Internship</p>
                </div>
            ...
            <div className="mt-10 pt-8 border-t border-border">
              <h3 className="font-heading font-semibold text-xl text-foreground flex items-center gap-2 mb-6">
                <Layers className="w-6 h-6 text-primary" /> BDS - Course Description
              </h3>
              <ul className="grid md:grid-cols-2 gap-3 text-muted-foreground ml-2">
